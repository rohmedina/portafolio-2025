...
export function useSEO(options: SEOOptions = {}) {
  ...
  // Normaliza canonical removiendo cualquier fragmento (#seccion)
  const canonicalNormalized = (canonical || baseUrl).split('#')[0]
  ...
  useHead({
    ...
    meta: [
      ...
      { property: 'og:url', content: canonicalNormalized },
    ...
    link: [
      { rel: 'canonical', href: canonicalNormalized }
    ]
  })
